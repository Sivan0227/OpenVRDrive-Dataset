...
def get_filename_from_path(path: str) -> str:
    ...
    actual_name: str = os.path.basename(path).replace(".txt", "")
    # actual_name: str = path.split(delim)[-1].replace(".txt", "")
    # final_chunk_name = path.split(delim)[-1]
    # print('final_chunk_name',final_chunk_name, final_chunk_name.rfind("."))
    # actual_name = final_chunk_name[: final_chunk_name.rfind(".")]
    return actual_name
